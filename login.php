...
<title>PT. HERO SUPERMARKET</title>
    ...
    <div class="navbar navbar-default navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          <a href="index.php" class="navbar-brand"><font class="logo2">SYSTEM SUPPLIER MANAGEMENT</font></a>
 ...
 <form role="form" action="?op=in" method="post" class="form-horizontal col-md-3">
  ...
  <div class="form-group">
    ...
    <button type="submit" class="btn btn-info">Masuk</button>
      ...
      <div class="container-fluid">
        <hr>
        <small>Copyright &copy;PT. Hero Supermarket <?php echo date('Y'); ?></small>
      </footer>
      <hr>
